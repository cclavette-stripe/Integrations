        ...
        stripe
          ...
          .then(function (data) {
            ...
            if (data.error) {
              ...
              if (data.paymentMethod.card.country == "US") {
                console.log(data.paymentMethod.card.country);
                stripe
                  .createPaymentMethod({
                    type: "card",
                    card: card,
                  ...
                  .then(function (data) {
                    console.log(
                      "Payment method created! " + data.paymentMethod.id
                    );
                ...
                console.log("Payment method created! " + data.paymentMethod);
                let paymentMethod = data.paymentMethod;
